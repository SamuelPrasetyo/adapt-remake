...
const TABS = [
    ...
    {
        // Berisi Perjanjian Kerja (wajib) + Dokumen Lainnya kader.
        id: "dokumen",
        label: "Dokumen",
        icon: (
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                    d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2zM13 3v6h6" />
            </svg>
        ),
    },
    {
...
export default function KaderSayaDetail({
    ...
    // Summary Monthly Feedback = tab khusus Admin MAI; Dokumen disembunyikan dari Kader.
    ...
    // false, jadi tab yang tersisa persis Overview, Feedback, Penilaian OJT, Dokumen, Report.
    const visibleTabs = TABS.filter((t) => {
        if (kaderView && t.id === "dokumen") return false;
    ...
    // Tab "Perjanjian Kerja" berganti nama menjadi "Dokumen"; link/bookmark lama
    // yang masih memakai #perjanjian tetap mendarat di tab yang benar.
    const rawHash = typeof window !== "undefined" ? window.location.hash.replace("#", "") : "";
    const hashTab = rawHash === "perjanjian" ? "dokumen" : rawHash;
        ...
        >
            ...
            {tab === "dokumen" && (
                <DokumenTab
                    ...
                    canManageDokumenLainnya={canManageDokumenLainnya}
                    canUpload={canUpload}
                    kaderId={kaderId}
                />
            )}
